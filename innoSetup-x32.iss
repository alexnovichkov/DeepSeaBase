...
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5Core.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5Gui.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5OpenGL.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5PrintSupport.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5Svg.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5Widgets.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5WinExtras.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5Multimedia.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\bin\Qt5Network.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\plugins\iconengines\*.dll"; DestDir: "{app}\iconengines"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*d.dll"
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\plugins\imageformats\*.dll"; DestDir: "{app}\imageformats"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*d.dll"
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\plugins\platforms\*.dll"; DestDir: "{app}\platforms"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*d.dll"
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\plugins\printsupport\*.dll"; DestDir: "{app}\printsupport"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*d.dll"
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\plugins\audio\*.dll"; DestDir: "{app}\audio"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*d.dll"
Source: "C:\Qt\Qt5.12.8\5.12.8\mingw73_32\plugins\mediaservice\*.dll"; DestDir: "{app}\mediaservice"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*d.dll"
