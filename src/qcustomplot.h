...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(QCPRange maxRange READ maxRange WRITE setMaxRange)
...
public:
  ...
  */
  ...
  const QCPRange maxRange() const { return maxRange_; }
  ...
  Q_SLOT void setMaxRange(const QCPRange &range);// {maxRange_ = range;}
